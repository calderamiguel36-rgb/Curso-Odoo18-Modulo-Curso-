...
class DateReportWizard(models.TransientModel):
    _name='covid__crud.date.report.wizard'
    ...
    def print_report(self):
        ...
        data={
            #- 'doc_ids' : self.ids,
            #- 'doc_model': self.env['covid__crud.date.report.wizard],
            #- 'docs : self,
        ...
        return self.env.ref('covid__crud.report_DateReportExternalayout').report_action(self,data=data)
